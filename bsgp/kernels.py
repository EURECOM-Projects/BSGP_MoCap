...
from .utils import get_lower_triangular_from_diag, get_lower_triangular_uniform_random, kron_ones
import gpflow
...
class Stationary(Kernel):
    ...
    def __init__(self, input_dim, variance=0.1, lengthscales=1.0,
        ...
        self.loglengthscales = tf.Variable(np.log(lengthscales), dtype=tf.float64, name='log_lengthscales', trainable=False)
